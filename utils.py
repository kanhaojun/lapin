...
class myNormalize:
    def __init__(self, data_name, train=True):
        stats = {
            'isic18': ((157.561, 26.706), (149.034, 32.022)),
            'isic17': ((159.922, 28.871), (148.429, 25.748)),
            'isic18_82': ((156.2899, 26.5457), (149.8485, 35.3346)),
            'isiccombine': ((157.561, 26.706), (149.034, 32.022)),
            'isicdf': ((157.561, 26.706), (149.034, 32.022)),
            'sdsaliency900': ((111.324, 52.609), (111.514, 53.572)),
            'sd900': ((111.324, 52.609), (111.514, 53.572)),
            'sd900combine': ((111.324, 52.609), (111.514, 53.572)),
            'polyp': ((86.17, 69.08), (86.17, 69.08)),
        }
        if data_name not in stats:
            raise ValueError(f'Unsupported dataset for normalization: {data_name}')
        self.mean, self.std = stats[data_name][0 if train else 1]
